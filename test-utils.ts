...
export function generateTestFormData(
  ...
  return {
    ...
    data: {
      date: '2024-01-15',
      whoCompleting: 'John Doe',
      location: 'Building A, Floor 3',
      inspectedWith: 'Jane Smith',
      generalHazardManagement: {
        ahasAvailable: 'Yes',
        ahasAvailableComment: 'All AHAs current and accessible',
        ahasReviewedWithEmployees: 'Yes',
        ahasReviewedComment: 'Reviewed during morning briefing',
        discussedInMeetings: 'Yes',
        discussedInMeetingsComment: 'Covered in weekly safety meeting',
      },
      inspectionItems: {
        generalComments: 'Yes',
        generalCommentsText: 'Site conditions good with proper safety measures',
        generalSitePhotos: 'No',
        eliminateRebarReviewed: 'Yes',
        eliminateRebarComment: 'All exposed rebar capped',
        ahaCompleted: 'Yes',
        ahaCompletedComment: 'AHA completed and signed',
        engineeringControls: 'Yes',
        engineeringControlsComment: 'Guardrails and barricades installed',
        workAreaIsolated: 'Yes',
        workAreaIsolatedComment: 'Work zones barricaded',
        warningSignage: 'Yes',
        warningSignageComment: 'Warning signs posted',
        workAreaInspected: 'Yes',
        workAreaInspectedComment: 'Daily inspection completed',
        devicesReplaced: 'Yes',
        devicesReplacedComment: 'Protection devices maintained',
        proceduresReviewed: 'Yes',
        proceduresReviewedComment: 'Procedures reviewed with crew',
        adequateProtection: 'Yes',
        adequateProtectionComment: 'All hazards have protection',
        rebarStorageInspected: 'Yes',
        rebarStorageComment: 'Storage area organized',
      },
      safetyObservations: {
        observation1: 'Crew demonstrated excellent awareness',
        observation2: 'Recommend additional caps for next phase',
        observation3: 'Overall safety culture is strong',
      },
    },
    emailOptions: {
